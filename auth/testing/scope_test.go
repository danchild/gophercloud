...
func TestScopeRejectsSystemAndProjectOrDomainScope(t *testing.T) {
	tests := []struct {
		name  string
		scope auth.Scope
	}{
		{
			name:  "system and project ID",
			scope: auth.Scope{System: true, ProjectID: "project-id"},
		},
		{
			name:  "system and project name",
			scope: auth.Scope{System: true, ProjectName: "project-name", ProjectDomainID: "project-domain-id"},
		},
		{
			name:  "system and domain ID",
			scope: auth.Scope{System: true, DomainID: "domain-id"},
		},
		{
			name:  "system and domain name",
			scope: auth.Scope{System: true, DomainName: "domain-name"},
		},
	}
